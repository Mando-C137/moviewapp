...
export default async function ReviwersPage() {
    ...
    <Routepage name="Moview - Reviewers" action={{ type: "reset" }}>
      <Pagewrapper>
        ...
        <div className="text-medium p-2">
          <p className="bg-mygray-100 px-8 py-2 text-lg font-medium text-mygray-500 shadow-sm ">
...
const Reviewercard = ({
  ...
  reviewer: Awaited<ReturnType<typeof getReviewers>>[number];
}) => {
  return (
